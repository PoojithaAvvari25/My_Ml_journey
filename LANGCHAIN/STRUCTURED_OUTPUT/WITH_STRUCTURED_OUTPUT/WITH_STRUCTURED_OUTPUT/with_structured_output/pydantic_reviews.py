...
class Review(BaseModel):
    ...
    sentiment: Literal["po","neg","neu"]=Field(description="Return sentiment as positive, negative or neutral")
    pros: list[str]=Field(description="Write down all pros in a list")
    cons: list[str]=Field(description="Write down all cons in a list")
    name:str=Field(description="write the name of the  reviewer not product beibg reviewed")
